...
<template>
    <ComboComponent>
        <div class=" py-[30px] px-[77px] bg-white rounded-xl min-h-[780px]">
            ...
            <div class=" text-2xl flex justify-between items-center max-md:block">
                ...
                <div class="flex items-center my-4 max-[460px]:flex-col max-[460px]:h-36 max-[460px]:justify-between">
                    <div v-if="role == 'admin'">
                    ...
                    <button @click.prevent="modalFlag = !modalFlag" class=" ml-10 max-[460px]:ml-0">
                    ...
                    <button class=" ml-10 max-[460px]:ml-0" @click.prevent="logout">
        ...
        <div class=" bg-black bg-opacity-50 h-full w-full flex items-center justify-center fixed top-0 left-0 text-lg">
            ...
            <div class=" min-w-[400px] max-[490px]:min-w-[320px] max-[490px]:px-4 py-8 px-[77px] bg-white rounded-md">
                <div class=" flex justify-between">
                    ...
                    <button @click.prevent="deleteAcc()">
    ...
    <div v-if="modalDeleteFlag">
        <div class=" bg-black bg-opacity-50 h-full w-full flex items-center justify-center fixed top-0 left-0 text-lg">
            <div class=" min-w-[400px] py-8 px-[77px] bg-white rounded-md flex flex-col items-center">
                ...
                <input v-model="passwordDelete" type="password" class=" w-[370px] h-[30px] px-[10px] focus:outline-none focus:border-2 
                focus:border-blue-800 border-2 border-gray-400 rounded my-4 placeholder:font-light" placeholder="Введите ваш пароль">
                <div class=" flex flex-col items-center mt-5">
