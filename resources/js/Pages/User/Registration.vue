...
<template>
    ...
    <section class=" bg-cover bg-center bg-[url(/public/img/background/page-course.svg)] h-screen flex">
        <div class=" bg-white w-[340px] py-[30px] flex flex-col items-center rounded-md my-auto mx-auto min-[370px]:w-[562px]">
            ...
            <div>
                <input v-model="name" type="text" class=" w-72 h-[30px] px-[10px] focus:outline-none focus:border-2 
                focus:border-blue-800 border-2 border-gray-400 rounded mt-[5px] placeholder:font-light min-[370px]:w-[370px]" placeholder="Введите имя">
            ...
            <div>
                ...
                focus:border-blue-800 border-2 border-gray-400 rounded mt-[5px] placeholder:font-light min-[370px]:w-[370px]" placeholder="Введите email">
            ...
            <div>
                ...
                focus:border-blue-800 border-2 border-gray-400 rounded mt-[5px] placeholder:font-light min-[370px]:w-[370px]" placeholder="Введите пароль">
                <p class=" text-red-600 ml-4 font-light" v-if="password_error">{{ password_error[0] }}</p>
            </div>
            <div>
                <input v-model="password_confirm" type="password" class=" w-72 h-[30px] px-[10px] focus:outline-none focus:border-2 
                focus:border-blue-800 border-2 border-gray-400 rounded mt-[5px] placeholder:font-light min-[370px]:w-[370px]" placeholder="Введите пароль повторно">
                <p class=" text-red-600 ml-4 font-light" v-if="password_confirm_error">{{ password_confirm_error[0] }}</p>
            </div>
            <button @click.prevent="registration()" class=" px-[30px] py-[10px] bg-gray-100 hover:bg-blue-200 hover:text-blue-600 rounded-md my-[20px] text-lg transition ease-in">Зарегестрироваться</button>
