        ...
        <div class=" bg-black bg-opacity-50 h-full w-full flex items-center justify-center fixed top-0 left-0 text-lg">
            <div class=" min-w-[400px] py-8 px-4 bg-white rounded-md">
                ...
                <!-- <div class="flex items-center min-h-[30px]">
                    ...
                    <button class="px-[10px] py-[5px] hover:bg-blue-200 hover:text-blue-600 rounded-md text-lg transition ease-in ml-2">+</button>
                </div> -->

                <div v-for="(elem, index) in students" :key="index">
                    ...
                    <div v-if="student_course.length">  
                        ...
                        <div v-for="(elem, index) in student_course" :key="index">
                            <div class=" flex items-center justify-between mt-2">
                                ...
                                <div @click.prevent="deleteStudent(elem.id, index)">
